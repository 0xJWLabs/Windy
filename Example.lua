local Windy = loadstring(game:HttpGet("https://tree-hub.vercel.app/api/UI/Windy"))()

local Window = Windy:CreateWindow({
    Title = "Windy Library",
    Icon = "door-open",
    Author = "Example UI",
    Folder = "CloudHub",
    ...
    KeySystem = { 
        ...
        --     Title = "Thumbnail"
        -- },
        URL = "https://github.com/Footagesus/Windy", -- remove this if the key is not obtained from the link.
...
Tabs.CodeTab:Code({
    ...
    Code = [[
local Windy = loadstring(game:HttpGet("https://raw.githubusercontent.com/Footagesus/Windy/refs/heads/main/dist/main.lua"))()
...
local themeValues = {}
for name, _ in pairs(Windy:GetThemes()) do
...
local themeDropdown = Tabs.WindowTab:Dropdown({
    ...
    Callback = function(theme)
        Windy:SetTheme(theme)
    end
})
themeDropdown:Select(Windy:GetCurrentTheme())
...
Tabs.WindowTab:Button({
    ...
    Callback = function()
        if fileNameInput ~= "" then
            SaveFile(fileNameInput, { Transparent = Windy:GetTransparency(), Theme = Windy:GetCurrentTheme() })
        end
    end
})
    ...
    Callback = function()
        if fileNameInput ~= "" then
            ...
            if data then
                ...
                if data.Theme then Windy:SetTheme(data.Theme) end
            end
        end
    end
})
...
local currentThemeName = Windy:GetCurrentTheme()
local themes = Windy:GetThemes()
...
function updateTheme()
    ...
    Windy:SetTheme(currentThemeName)
end
